    ...
    fluidRow(column(8,
      ...
      wellPanel(
        ...
        HTML(climpactUI$sampleText,
            "<a target=\"_blank\" href=sample_data/sydney_observatory_hill_1936-2015.txt> sydney_observatory_hill_1936-2015.txt</a></p>"),
        ...
        numericInput(ns("stationLat"), "Latitude (decimal degrees e.g. -40.992):", 0, min = -90, max = 90),
        numericInput(ns("stationLon"), "Longitude (decimal degrees e.g. 148.346):", 0, min = -180, max = 180),
      ...
      box(title = "Instructions", width = 12,
        ...
        HTML("<p>Specify the station latitude and longitude in decimal degrees<br />e.g. -40.992 or 148.346.<br />",
